...
content_blocks:
  - _bookshop_name: hero
    title: Hola, soy Vanessa Marley.
    description_html: >-
      <p><strong>Fotógrafo</strong> y <strong>estratega de contenido
      visual</strong> de Albany. Trabajo como fotógrafo de estilo de vida,
      productos y paisajes, creando imágenes para una amplia gama de
      solicitudes, desde medios digitales hasta obras impresas.</p>
    image: /images/01.jpg
